...
#SBATCH --mem=48G
#SBATCH --time=4:00:00
#SBATCH --output=/global/home/users/kh36969/exclusion_gene_project/logs/fpr_%j.out
#SBATCH --error=/global/home/users/kh36969/exclusion_gene_project/logs/fpr_%j.err
set -euo pipefail
...
python3 -u scripts/169_false_positive_rate.py
