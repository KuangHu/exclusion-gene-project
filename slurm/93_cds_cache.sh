...
#SBATCH --time=4:00:00
#SBATCH --array=0-15
#SBATCH --output=/global/home/users/kh36969/exclusion_gene_project/logs/93_cache_%A_%a.out
#SBATCH --error=/global/home/users/kh36969/exclusion_gene_project/logs/93_cache_%A_%a.err
set -euo pipefail
...
python3 "$P/scripts/93_cds_cache.py" \
