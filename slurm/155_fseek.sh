...
#SBATCH --mem=32G
#SBATCH --time=1:00:00
#SBATCH --output=/global/home/users/kh36969/exclusion_gene_project/logs/fseek_%j.out
#SBATCH --error=/global/home/users/kh36969/exclusion_gene_project/logs/fseek_%j.err
set -euo pipefail
